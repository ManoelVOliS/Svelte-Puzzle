<script>
	...
	let vetor = [
        "./public/Fuleco/1.jpg","./public/Fuleco/2.jpg","./public/Fuleco/3.jpg","./public/Fuleco/4.jpg","./public/Fuleco/5.jpg","./public/Fuleco/6.jpg","./public/Fuleco/7.jpg","./public/Fuleco/8.jpg","./public/Fuleco/9.jpg"
    ];
	...
	function trocarPosi(pos1,pos2){
		...
		for(let i in arr){
			for(let j in arr[i]){
				if(conjuntoBackup[i][j] != arr[i][j].replace("./public/Fuleco/", "").replace(".jpg","")){
	...
	function gabarito(){
		Swal.fire({
			...
			imageUrl: '../public/Fuleco/Mascote completo.jpg',
			imageWidth: 360,
			imageHeight: 360,
	...
	<style>
		*{
		...
		div.Caixa{
			background-image: url('https://media.tenor.com/53mmUaqb1b0AAAAC/copa-torcedor.gif');
